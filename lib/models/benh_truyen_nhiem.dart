...
class BenhTruyenNhiem {
  ...
  final CategoryItem? ngheNghiepItem;       // 11. NgheNghiep
  ...
  factory BenhTruyenNhiem.fromFirestore(Map<String, dynamic> d, String docId) {
    ...
    return BenhTruyenNhiem(
      ...
      danTocItem:            cat(d['danToc'] ?? d['danTocId'], CategoryOptions.danToc),
      ...
      ngheNghiepItem:        cat(d['ngheNghiep'],         CategoryOptions.ngheNghiep),
      noiLamViecHoc: d['noiLamViec'] ?? d['noiLamViecHoc'],
      diaChinoiLamViecHoc: d['diaChiNoiLamViec'] ?? d['diaChinoiLamViecHoc'],
      cityIdHocItem:         cat(d['cityIdHoc'],          CategoryOptions.tinh),
      wardIdHoc: d['wardIdHoc']?.toString(),
      noiOHienNay: d['noiOHienNay'],
      cityIdItem:            cat(d['cityId'],             CategoryOptions.tinh),
      wardId: d['wardId']?.toString(),
      khuPhoAp: d['khuPhoAp']?.toString(),
      soHSBA: d['soHSBA'],
      ...
      benhNenKemTheoItem:    cat(d['benhNenKemTheo'] ?? d['benhNenKemTheoId'], CategoryOptions.benhNen),
      ...
      donViDieuTra: d['donViDieuTra']?.toString(),
  ...
  Map<String, dynamic> toFirestore() => {
    ...
    if (noiLamViecHoc != null)         'noiLamViec':         noiLamViecHoc,
    if (diaChinoiLamViecHoc != null)   'diaChiNoiLamViec':   diaChinoiLamViecHoc,
